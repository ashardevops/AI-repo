...
def write_json_to_file():
    ...
    """
    json_object = json.dumps(create_dict())  # Convert dictionary to JSON string
    with open("output.json", "w") as newfile:  # Open file in write mode
        newfile.write(json_object)  # Write JSON string to file
